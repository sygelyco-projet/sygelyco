...
//index.php  	 
	...
	//--login form
	define('titre', 'Log in');
	define('erreur', 'Error in connection, check your login and password.');
	define('nom_user', 'User name');
	define('passe_user', 'Password');
	define('se_rappeler', 'Remember me');
	define('passe_oublie', 'Forgot Password?');
	
	//--menu
	 define('menu1', 'Home');
	 define('menu2', 'Consultations');
	 define('menu3', 'About');
	 define('menu4', 'Where to start');
	 define('menu5', 'authors');
	 define('menu6', 'Contacts');
	 define('menu7', 'Archives');
	 define('menu8', 'Suggestions');
	 
	 //-- footer
	 define('signature', 'SYGELYCO DESIGN BY DAK-SOFT');
	 
	 //-- content
	 define('a_propos_lycee', 'About the high school');
...
//Home.php
	...
	define('deconnexion', 'Log out');
	 ...
	 //matiere
	 define('welcome_matiere', 'Register a course');
	 define('nom_matiere', 'Course name');
	 define('abre_matiere', 'abbreviation of the course');
	 define('des_matiere', 'Description of the course');

	 //sequence
	 define('welcome_seq', 'Sequence recording');
	 define('nom_seq', 'Sequence name');
	 define('abre_seq', 'abbreviation of the Sequence');
	 define('des_seq', 'Description of Sequence');
?>